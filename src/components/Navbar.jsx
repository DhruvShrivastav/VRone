...
const Portfolio = [
  { name: 'Mall Cosmetics', description: '', href: '#' },
  { name: 'Cosmetic Shops', description: '', href: '#' },
  { name: 'Mall Kiosks', description: '', href: '#', },
  { name: 'Brand Promotions', description: '', href: '#'},
    ...
    <header className="sticky top-0 z-50 bg-white shadow-md">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/SignIn" className="text-lg font-semibold leading-6 text-gray-900">
